...
class ChallengeComplainFail extends StatefulWidget {
  final String docId;
  final String uid;
  ...
  @override
  State<ChallengeComplainFail> createState() => _ChallengeComplainFailState();
}

class _ChallengeComplainFailState extends State<ChallengeComplainFail> {
  ...
  // Future<void> callChallengeComplainToChallengeAndDeleteFunction(
  //     String checkupDocId) async {
  //   try {
  //     final result =
  //         await FirebaseFunctions.instanceFor(region: 'asia-northeast3')
  //             .httpsCallable('challengeComplainToChallengeAndDelete')
  //             .call(<String, dynamic>{
                              ...
                              child: BigButtonFirst(
                                ...
                                onPressed: () async {
                                  try {
                                    ...
                                    DocumentReference checkupRecordRef =
                                        FirebaseFirestore.instance
